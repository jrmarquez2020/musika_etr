...
class PianoViewLyrics extends StatefulWidget {
  final String id;
  const PianoViewLyrics({required this.id});

  @override
  State<PianoViewLyrics> createState() => _PianoViewLyricsState();
}

class _PianoViewLyricsState extends State<PianoViewLyrics> {
