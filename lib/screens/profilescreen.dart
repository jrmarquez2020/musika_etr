...
import 'package:avatar_glow/avatar_glow.dart'; // Import the avatar_glow package
      ...
      body: Container(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              AvatarGlow( // Wrap CircleAvatar with AvatarGlow
                glowColor: Colors.white, // Customize the glow color
                child: CircleAvatar(
                  radius: 50,
